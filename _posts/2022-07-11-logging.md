...
I had originally wanted to do everything entirely on prem, by deploying a Minio cluster -- but I would need to monitor and collect logs for that, so I ednde up in a Catch-22[^minio_reliability].
...
Even the Grafana Free Tier would have been a great choice with other priorities -- really simple to create a set of servers that I could just shunt data too -- but I'm here to learn by doin
One day a client might ask me to do something wierd with Loki so I might  as well fiddle at home!
